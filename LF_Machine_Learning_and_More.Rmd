...
```
The tree suggests that the recipes with higher cook time corresponds to lower total number of ratings.
...
In the RecipeTin website, there are technically 9 cusine categories (Asian,French,Greek,Indian,Italian,Mediterranean,Mexican,Middle Eastern, and South America). Yet, it turns out there is actually 178 different type of cuisine categories in this website after webscrapping, making it difficult to have cuisine as a predictor. We do wonder in that if the type od cuisine plays any role in popularity of a recipe and wanted to create a world map of the different types of cuisines (which is shown later on). We all experienced at some point random cravings of certain types of food. With that said, let us explore the relationship between number of ratings and different types of cuisines. In order to see the correlation and include the `cuisine` predictor in the decision tree model, we regrouped the 178 different types of cuisines from this websites into 12 categories (similar to the cuisine category from the 1) European/Western, 2) Americanized_cultural_food,3) Asian, 4) Australian,5) French,6) Indian,7) Italian,8)Mediterranean,9) Mexican, 10) Middle Eastern, 11) South American/Caribbean, and 12) other which includes categories of dog food, holidays, and categories not in particular to region.
...
`Any flavour you want!, Western`="European/Western",
`American, Thanksgiving`="European/Western",
`BBQ, Southern, Texas, Western`="European/Western",
`Western`="European/Western",
`Western food`="European/Western",
`Universal, Western`="European/Western",
...
`South Western`="European/Western",
`South Western`="European/Western",
`Southern, Western`="European/Western",
`South Western, Western`="European/Western",
`Nordic`="European/Western",
`Irish`="European/Western",
`Christmas, Holiday, Western`="European/Western",
...
`Hawaiian, Tropical!`="Americanized_cultural_food",
`Tropical!, Western`="European/Western",
